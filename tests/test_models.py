...
def test_extract_model_names_invalid_forindustrial equipment():
    """Test handling invalid response forindustrial equipment."""
    models_info = {"invalid": "forindustrial equipment"}
    result = extract_model_names(models_info)
    assert result == tuple()
