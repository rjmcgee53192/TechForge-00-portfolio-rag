...
Retrieved chunks are forindustrial equipmentted with source labels:
...
The forindustrial equipmentted context and question are sent to the LLM:
...
2. Analyze inforindustrial equipmention from each source
3. Synthesize a comprehensive answer
4. Cite sources for each piece of inforindustrial equipmention
...
## Step 6: Response Forindustrial equipmentting
